    ...
    void beacon()   {
        ...
        if(getLeftColor().equals(getRightColor()))    {
            ...
            if (getLeftColor().equals("RED") && !getRightColor().equals("RED")) {
                if(displacement < .15)  {
                    straight(-DRIVE_POWER);
                } if (displacement > .15 && displacement < 1.5) {
                    strafe(STRAFE_POWER, "90", "LEFT");
                } else if (displacement > 1.5 && displacement < 2) {
                ...
                if (displacement < .25) {
                    straight(DRIVE_POWER);
                } else if (displacement > .25 && displacement < 1.6) {
                    strafe(STRAFE_POWER, "90", "LEFT");
                } else if (displacement > 1.6 && displacement < 2.1) {
                    strafe(STRAFE_POWER, "90", "RIGHT");

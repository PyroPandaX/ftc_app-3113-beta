    ...
    void beacon()   {
        ...
        if(getLeftColor().equals(getRightColor()))    {
            ...
            if (getLeftColor().equals("RED") && !getRightColor().equals("RED")) {
                if(displacement < .15)  {
                    straight(-DRIVE_POWER);
                } if (displacement > .15 && displacement < 1.15) {
                    strafe(STRAFE_POWER, "90", "LEFT");
                } else if (displacement > 1.15 && displacement < 1.95) {
                    strafe(STRAFE_POWER, "90", "RIGHT");
                } else if (displacement > 1.95) {
                    if(turnToAngle(0)) {
                        resetDrive();
                        timeStep.clear();
                        pushed++;
                ...
                if (displacement < .25) {
                    straight(DRIVE_POWER);
                } else if (displacement > .25 && displacement < 1.3) {
                    strafe(STRAFE_POWER, "90", "LEFT");
                } else if (displacement > 1.3 && displacement < 2.1) {
                    strafe(STRAFE_POWER, "90", "RIGHT");

 ...
 */
@Autonomous(name="StrafeBlue", group="NullBot")
//@Disabled
public class StrafeBeaconBlue extends OpMode{
    ...
    public void loop() {
        ...
        if (timeAuto < 1.5) {
            ...
            motorLF.setPower(-.2);
            motorRF.setPower(-.2);
        } else if (timeAuto > 11.5 && timeAuto < 15.5) {
            rotate();
        } else if (timeAuto > 15.5 && timeAuto < 16.5) {
            motorLB.setPower(-.2);
            motorRB.setPower(-.2);
            motorLF.setPower(-.2);
            motorRF.setPower(-.2);
        } else if (timeAuto > 16.5 && !sawLine) {
            if (colorCcache[0] > 6) {
                motorLB.setPower(0);
                motorRB.setPower(0);
                motorLF.setPower(0);
